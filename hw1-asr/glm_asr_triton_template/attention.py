...
def flash_attention_kernel(
    ...
    """FlashAttention-style kernel with online softmax accumulation."""
    pid_bh = tl.program_id(0)
...
def _flash_attention(
    ...
    """FlashAttention-style Triton path for no-mask self-attention."""
    ...
    grid = (batch_heads, triton.cdiv(seq_q, block_m))
...
def scaled_dot_product_attention(
    ...
    use_flash = (
        ...
        and head_dim <= MAX_FLASH_HEAD_DIM
        and seq_k <= MAX_FLASH_SEQ
    )
